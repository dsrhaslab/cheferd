...
// Initialize call. Fills housekeeping rules and operations supported by control application.
...
void CoreControlApplication::execute_feedback_loop ()
{
    ...
    std::list<std::string> hi = {};
    std::list<std::string>& sessions_sent = hi;
...
CoreControlApplication::collect_statistics_global ()
{
    ...
    // std::cout << "Size local sessions: " << local_sessions_.size() << std::endl;
